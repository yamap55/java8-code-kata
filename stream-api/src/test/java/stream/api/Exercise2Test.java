...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void sortByAge() {
         ...
         */
        Stream<Integer> sortedAgeStream = customerList.stream().map(Customer::getAge).sorted((a,b) -> a-b);
    ...
    public void top3RichCustomer() {
         ...
         */
        Stream<String> top3RichCustomerStream = customerList.stream().sorted((a,b)->b.getBudget() - a.getBudget()).limit(3).map(Customer::getName);
    ...
    public void itemsCustomersWantToBuy() {
         ...
         */
        Function<Customer, Stream<Item>> getItemStream = cus -> cus.getWantToBuy().stream();
        Stream<String> itemStream = customerList.stream().flatMap(getItemStream).map(s->s.getName());
