...
public class Exercise5Test extends ClassicOnlineStore {
    ...
    public void nameList() {
         ...
         */
        List<String> nameList = customerList.stream().map(cus -> cus.getName()).collect(Collectors.toList());
    ...
    public void ageSet() {
         ...
         */
        Set<Integer> ageSet = customerList.stream().map(cus -> cus.getAge()).collect(Collectors.toSet());
    ...
    public void ageDistribution() {
        ...
        Map<Integer, Long> ageDistribution = customerList.stream()
                .collect(Collectors.groupingBy(cus -> cus.getAge(), Collectors.counting()));
